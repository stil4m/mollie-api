...
public class CreateIdealPaymentTest {
    ...
    public void testSerialize() throws IOException {
        ...
        String serialized = objectMapper
                .writeValueAsString(new CreateIdealPayment(1.0, "Description", "redirectUrl", Optional.empty(), metaData, new IdealPaymentOptions("MyIssuer")));
    ...
    public void testSerializeWithWebhookUrl() throws IOException {
        ...
        metaData.put("mySpecialKey", "value");
        String serialized = objectMapper
                .writeValueAsString(new CreateIdealPayment(1.0, "Description", "redirectUrl", Optional.of("webhookUrl"), metaData, new IdealPaymentOptions("MyIssuer")));
